 ...
 *
 * `via` (penanda bridge/native, mis. "repliz") disembunyikan dari user —
 * user tidak perlu tahu akunnya konek lewat bridge atau API native. Penanda
 * ini tetap tersimpan di DB dan ditampilkan di admin panel (org-activity,
 * logs) utk pengecekan & maintenance. */
const HIDDEN_METADATA_KEYS = new Set(["via"]);
