// Admin: Pemakaian AI — log semua generate AI (caption, hashtag, SEB, dll) lintas organisasi
...
export function AdminAiUsagePage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["admin-ai-usage", action, page],
    queryFn: () => {
              ...
              <div key={log.id} className="flex flex-wrap items-center gap-3 p-4">
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-sm">
                    ...
                    {log.userName && (
                      <span className="text-[var(--text-muted)]"> · {log.userName}</span>
                    )}
                  </p>
