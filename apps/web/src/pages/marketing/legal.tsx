    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Retensi data per platform social media: Meta (Facebook/Instagram/Threads) — token akses disimpan selama akun aktif, data engagement (komentar, pesan) dihapus dalam 30 hari setelah permintaan penghapusan; TikTok — access token berlaku 24 jam, refresh token berlaku 365 hari, metadata konten disimpan selama akun aktif; YouTube — token disimpan selama akun aktif, metadata video upload tidak disimpan secara permanen di server kami karena langsung diunggah ke YouTube; LinkedIn — token berlaku 60 hari, data company page disimpan selama akun aktif; Pinterest — access token berlaku 30 hari, refresh token berlaku 60 hari (rotating), data analytics dan metadata pin tidak disimpan secara permanen (di-fetch on-demand sesuai Pinterest Developer Guidelines); Bluesky — session disimpan selama akun aktif; Google Business Profile — token disimpan selama akun aktif, data local post disimpan selama akun aktif.",
