...
export const PLATFORM_RULES: Record<Platform, PlatformRule> = {
    ...
    TIKTOK: { label: "TikTok", maxCaptionChars: 2200, minMedia: 1, mediaTypes: ["image", "video"] },
    YOUTUBE: { label: "YouTube", maxCaptionChars: 5000, minMedia: 1, mediaTypes: ["video"] },
    PINTEREST: { label: "Pinterest", maxCaptionChars: 500, minMedia: 1, mediaTypes: ["image", "video"] },
