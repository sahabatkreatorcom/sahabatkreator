        ...
        <div className="prose prose-lg dark:prose-invert mt-8 max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              ...
              melindungi data pribadi Anda dari akses yang tidak sah, kehilangan, atau
              penyalahgunaan. Token akses sosial media dienkripsi (AES-256-GCM) dan layanan
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              Platform kami menggunakan cookies untuk meningkatkan pengalaman pengguna,
              menganalisis penggunaan, dan menyampaikan konten yang relevan.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              Kami dapat memperbarui kebijakan privasi ini sewaktu-waktu. Perubahan material
              akan diinformasikan melalui email atau notifikasi di platform.
            </p>
          </section>
