...
export default async function DashboardLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="flex min-h-screen">
            {/* Sidebar: hanya tampil di layar lg ke atas. Sticky + scroll internal.
          Di mobile, navigasi yang sama diambil dari nav-config.tsx dan dirender
          ulang oleh BottomNav — jadi tidak ada dua sumber daftar menu. */}
