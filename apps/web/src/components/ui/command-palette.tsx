...
const NAVIGATION_COMMANDS: PaletteCommand[] = [
  ...
  },
  {
    id: "nav-post-results",
    label: "Hasil Post",
    keywords: ["hasil", "performa", "views", "engagement", "top posts"],
    icon: BarChart3,
    group: "Navigasi",
    run: (n) => n("/post-results"),
  },
  {
    id: "nav-compose",
    label: "Buat Konten",
  ...
  },
  {
    ...
    keywords: ["adaptasi", "reuse", "generator", "ai"],
    icon: RefreshCcw,
    group: "Navigasi",
    run: (n) => n("/generator/repurpose"),
  },
  {
    id: "nav-carousel",
    label: "Carousel Generator",
    keywords: ["carousel", "slide", "generator", "ai"],
    icon: GalleryHorizontalEnd,
    group: "Navigasi",
    run: (n) => n("/generator/carousel"),
  },
  {
    id: "nav-media",
    label: "Media",
