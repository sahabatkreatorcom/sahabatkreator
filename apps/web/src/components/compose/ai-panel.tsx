  ...
  return (
    <div
      className={cn(
        ...
        variant === "card"
          ? "card p-6"
          : "rounded-[var(--radius-md)] border border-[var(--border-light)] bg-[var(--bg-tertiary)] p-4",
      )}
    >
      <div className="flex items-center justify-between">
        <h3 className={cn("flex items-center gap-2 font-semibold", variant === "inline" && "text-sm")}>
