...
function stagingSeoGuardPlugin() {
    return {
        name: "sahabatkreator:staging-seo-guard",
        apply: "build",
        closeBundle() {
            if (INDEXABLE)
                return; // Prod pakai robots.txt + sitemap.xml di public/
    ...
    plugins: [
        ...
        VitePWA({
            ...
            manifest: {
                ...
                lang: "id",
                description: "Kelola semua konten social media Anda dari satu tempat — jadwal posting, analitik, dan kolaborasi tim.",
                theme_color: "#0C1627",
