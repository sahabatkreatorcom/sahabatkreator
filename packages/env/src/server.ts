...
export const env = createEnv({
  server: {
    ...
    R2_ACCOUNT_ID: z.string().optional().describe("Cloudflare R2 account ID (storage media). Wajib diisi untuk fitur upload media."),
    R2_ACCESS_KEY_ID: z.string().optional().describe("Cloudflare R2 access key. Wajib diisi untuk fitur upload media."),
    R2_SECRET_ACCESS_KEY: z.string().optional().describe("Cloudflare R2 secret key. Wajib diisi untuk fitur upload media."),
    R2_BUCKET_NAME: z.string().optional().describe("Cloudflare R2 bucket untuk media. Wajib diisi untuk fitur upload media."),
    ...
    SUMOPOD_API_KEY: z.string().optional().describe("SumoPod API key untuk pembayaran."),
    SUMOPOD_API_SECRET: z.string().optional().describe("SumoPod API secret."),
    SUMOPOD_BASE_URL: z.string().optional().describe("SumoPod API base URL."),
    SUMOPOD_WEBHOOK_TOKEN: z.string().optional().describe("SumoPod webhook token untuk verifikasi callback."),
