...
async function ensureAdmin() {
  ...
  // Buat admin baru (password perlu di-hash — tapi schema.user.passwordHash?)
  // Fallback: return null dan suruh user buat manual via UI
  console.warn("Admin belum ada dan tidak bisa dibuat otomatis (butuh password hash).");
  console.warn("Buat admin via UI terlebih dahulu, lalu jalankan ulang seed.");
  return null;
}
