...
import { PLATFORM_DAILY_LIMITS, PublishError, type PublishInput } from "./types";
 ...
 * Platform yang didukung ditentukan sendReply (IG/FB/Threads/YT/Bluesky/LinkedIn);
 * TikTok & Pinterest tidak punya API create-comment → skip diam-diam.
 */
