...
3. M3: modul compose/publishing — composer UI (pilih akun, media dari library, caption) + simpan post + publish/schedule ke platform (publikasi per platform: IG Feed via Graph, FB Page, TikTok, dsb).
